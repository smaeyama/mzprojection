...
if __name__ == '__main__':
    ...
    outdata = outdata.transpose()
    np.savetxt('out1_check_memoryfunc.dat', outdata, fmt='%17.7e')
    ...
    outdata = outdata.transpose()
    np.savetxt('out1_check_r.dat', outdata, fmt='%17.7e')
    print(omega)
